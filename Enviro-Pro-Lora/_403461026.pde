// Code 9.5 Change  the nodeAddress and nodeID.
...
// Init USB port
    USB.ON();
    USB.println(F("SE Pro VITORIA"));
    USB.println(F("code v9.5"));
...
// CHANGING NODE ADDRESS FOR A NEW DEVICE 
  ...
  e = sx1272.setNodeAddress(node_address);
    USB.print(F("Setting Node Address to '22'.\t state "));
    USB.println(e);
    USB.println();
